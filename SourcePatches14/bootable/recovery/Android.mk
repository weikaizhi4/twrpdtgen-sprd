...
ifeq ($(TW_EMBEDDED_VENDOR_LIBS),true)
    LOCAL_CFLAGS += -DTW_EMBEDDED_VENDOR_LIBS
endif
...
ifeq ($(TW_INCLUDE_CRYPTO), true)
    ...
    LOCAL_STATIC_LIBRARIES += libkeymint_support libasync_safe
...
ifneq ($(TW_METADATA_FSTAB_PATH),)
    LOCAL_CFLAGS += -DTW_METADATA_FSTAB_PATH=\"$(TW_METADATA_FSTAB_PATH)\"
endif
